...
public class ImportRichterParcous {
    ...
    public ImportRichterParcous(RichterService rs, ParcoursBauerService ps,
                                RichterQualifikationService rqs, ParcoursBauerQualifikationService pqs) {
        this.richterService = rs;
        this.parcoursBauerService = ps;
        this.richterQualService = rqs;
        this.parcoursBauerQualService = pqs;
    }

    public void importRichterAndParcourBauer() {
